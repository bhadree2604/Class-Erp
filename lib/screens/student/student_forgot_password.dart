              ...
              child: ConstrainedBox(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text('Enter your Student ID to receive password reset instructions', textAlign: TextAlign.center, style: TextStyle(color: AppColors.textSecondary)),
                    const SizedBox(height: 32),
                    Align(alignment: Alignment.centerLeft, child: Text('Student ID', style: TextStyle(fontWeight: FontWeight.w600, color: AppColors.textPrimary, fontSize: 14))),
                    const SizedBox(height: 6),
                    TextField(controller: _studentIdCtrl, decoration: const InputDecoration(hintText: 'Enter your student ID')),
                    const SizedBox(height: 16),
                    Align(alignment: Alignment.centerLeft, child: Text('Email Address', style: TextStyle(fontWeight: FontWeight.w600, color: AppColors.textPrimary, fontSize: 14))),
                    const SizedBox(height: 6),
